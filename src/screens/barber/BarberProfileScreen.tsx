...
const BarberProfileScreen = () => {
  ...
  if (error || !barber) return <View style={styles.centerContainer}><Text style={{ color: theme.colors.error }}>Failed to load profile.</Text></View>;
    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1, backgroundColor: theme.colors.background }}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.headerSection}>
          ...
          <Text style={styles.subtitle}>Manage your professional presence</Text>
        </View>
            ...
            <View style={styles.avatarInfo}>
              ...
              <View style={styles.statsRow}>
                {barber.rating !== undefined && (
                  <View style={styles.statBadge}><Star size={12} color={theme.colors.primary} fill={theme.colors.primary} /><Text style={styles.statText}>{barber.rating.toFixed(1)}</Text></View>
                )}
                {barber.shopId && (
                  <View style={[styles.statBadge, { marginLeft: 8 }]}><Briefcase size={12} color={theme.colors.muted} /><Text style={styles.statText}>Shop #{barber.shopId}</Text></View>
                )}
              </View>
            </View>
          </View>
            ...
            <View style={styles.viewDetails}>
              ...
              <View style={styles.detailRow}>
                ...
                <View style={styles.detailContent}>
                  ...
                  <Text style={styles.detailValue}>{barber.email}</Text>
                </View>
              </View>
              <View style={styles.detailRow}>
                ...
                <View style={styles.detailContent}>
                  ...
                  <Text style={styles.detailValue}>{barber.phone || 'Not set'}</Text>
                </View>
              </View>
              <View style={styles.detailRow}>
                ...
                <View style={styles.detailContent}>
                  ...
                  <Text style={styles.detailValue}>{barber.bio || 'No bio added'}</Text>
                </View>
              </View>
               <View style={styles.detailRow}>
                ...
                <View style={styles.detailContent}>
                  ...
                  <Text style={styles.detailValue}>{barber.experienceYears || 0} Years</Text>
                </View>
              </View>
              {barber.skills && barber.skills.length > 0 && (
                <View style={styles.skillsContainer}>
                  <Text style={[styles.detailLabel, { marginBottom: 8 }]}>Skills</Text>
        ...
        {/* Password Card - The "Old" UI style */}
        {showPasswordCard && (
          <View style={styles.card}>
      ...
      <Modal visible={isModalVisible} transparent={true} animationType="fade" onRequestClose={() => setIsModalVisible(false)}>
        <View style={styles.modalContainer}>
          ...
          {barber.profilePicture && <Image source={{ uri: barber.profilePicture }} style={styles.fullScreenImage} resizeMode="contain"/>}
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  skillsContainer: { marginTop: 8 },
  skillTagsWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  skillTag: { backgroundColor: `${theme.colors.primary}1A`, paddingVertical: 4, paddingHorizontal: 10, borderRadius: 20 },
  skillTagText: { color: theme.colors.primary, fontSize: 12, fontWeight: '600' },
